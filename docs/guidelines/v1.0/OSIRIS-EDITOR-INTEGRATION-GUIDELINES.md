...
| Document URI | [OSIRIS-ADG-EI-1.0](https://github.com/osirisjson/osiris/tree/main/docs/guidelines/v1.0/OSIRIS-EDITOR-INTEGRATION-GUIDELINES.md) |
| Document Name | Editor Integration Guidelines |
